...
<%
    ...
    End If
        Sub calSubtotal(rs)
		    ...
		    subtotal = 0
		    do while not rs.EOF
			    subtotal = subtotal + Clng(mycart.Item(CStr(rs("id")))) * CDbl(CStr(rs("price")))
			    rs.MoveNext
		    loop
		    rs.MoveFirst
	    End Sub
                                    ...
                                    <div class="p-5">
                                        ...
                                        <form action="pay.asp" id="pay_form" method="POST">
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <input type="text" class="form-control" id="address" name="address" value="<% =Server.HtmlEncode(rs("address"))%>">
                                            </div>
                                            <div class="row">
