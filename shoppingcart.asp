                  ...
                  %>
                    <div class="row mb-4 d-flex justify-content-between align-items-center">
                      <div class="col-md-2 col-lg-2 col-xl-2">
                        <img
                          src="admin/quanly/anh/<% = rs("thumbnail")%>"
                          class="img-fluid rounded-3" alt="Cotton T-shirt">
                      </div>
                      <div class="col-md-3 col-lg-3 col-xl-3">
                        <h6 class="text-muted"><%= rs("title")%></h6>
                      </div>
                      ...
                      <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                        <h6 class="mb-0"><%= rs("price")%></h6>
                      </div>
                      <div class="col-md-1 col-lg-1 col-xl-1 text-end">
                      
                        <a href="removecart.asp?id=<%= rs("id")%>" class="text-muted"><i class="fas fa-times"></i></a>
                      </div>
                    </div>
  ...
  <%
                ...
                <div class="col-lg-4 bg-secondary-subtle <%= statusButtons %>">
                  <div class="p-5">
                    ...
                    <h5 class="text-uppercase mb-3">Giftcode</h5>
                    ...
                    <div class="row">
<button type="button" class="btn btn-success btn-lg" onclick="redirectToBilling()"
  data-mdb-ripple-color="dark">Purchase</button>

                    </div>
                    <script>
  function redirectToBilling() {
    window.location.href = "pay.asp";
  }
</script>
                  </div>
                </div>
